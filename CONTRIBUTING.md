# Contributing to 10th Maths

Thank you for your interest in contributing to **10th Maths**! We welcome contributions from the community to help improve and expand educational resources.
...
2. **Clone your Fork**:
   ```bash
   git clone https://github.com/<your-username>/10th-maths.git
   cd 10th-maths
   ```
