...
Distance between two points {{< katex >}}
...
| S.No. | Points | Distance | Mid Point | Internal | | External | |
|-------|--------|----------|-----------|----------|---|----------|---|
| | | | | Point | Ratio | Point | Ratio |
| (i) | (3,4), (5,5) | | | | 2:3 | | 2:3 |
| (ii) | (-7,13), (-3,1) | | | (13/3, 5) | | (-13, 15) | |

2. {{< katex >}}A(0,5){{< /katex >}}, {{< katex >}}B(5,0){{< /katex >}} and {{< katex >}}C(-4,7){{< /katex >}} are vertices of a triangle then its centroid will be at _______
