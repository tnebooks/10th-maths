...
\[
\text{C.S.A. of the cylinder} = 2 \times \frac{22}{7} \times 14 \times 20 = 2 \times 22 \times 2 \times 20 = 1760 \text{ cm}^2
\]

T.S.A. of the cylinder \( = 2\pi r(h + r) \) sq. units

\[
= 2 \times \frac{22}{7} \times 14 \times (20 + 14)
\]

\[
= 2 \times \frac{22}{7} \times 14 \times 34 = 2992 \text{ cm}^2
\]
...
The curved surface area of a cylinder is \( 88 \) sq. cm and its height is \( 14 \) cm. Find the diameter of the cylinder.
...
\[
2 \times \frac{22}{7} \times r \times 14 = 88 \qquad (h = 14 \text{ cm})
\]
...
Area covered in 1 revolution \( = 26.4 \text{ m}^2 \)

Area covered in 8 revolutions \( = 8 \times 26.4 = 211.2 \)

Therefore, area covered is \( 211.2 \text{ m}^2 \)
...
If one litre of paint covers \( 10 \text{ m}^2 \), how many litres of paint is required to paint the internal and external surface areas of a cylindrical tunnel whose thickness is \( 2 \) m, internal radius is \( 6 \) m and height is \( 25 \) m.

<center>Fig. 7.8</center>

#### Solution

Given that, height \( h = 25 \) m; thickness \( = 2 \) m; internal radius \( r = 6 \) m
...
\[
= \frac{s}{2\pi l} \times \pi l^2 = \frac{s}{2} \times l = \frac{2\pi r}{2} \times l \qquad (\because s = 2\pi r)
\]
...
\[
= \pi rl + \pi r^2 \quad (\because \text{the base is a circle})
\]
...
If the total surface area of a cone of radius \( 7 \) cm is \( 704 \text{ cm}^2 \), then find its slant height.
...
\[
= \frac{22}{7} \times 0.7 \times [4.8 + 2.5 + 0.7]
\]

\[
= \frac{22}{7} \times 0.7 \times 8 = 17.6
\]
...
Total surface area of hemisphere \( = \) C.S.A. \( + \) Area of top circular region \( = 2\pi r^2 + \pi r^2 \)
...
\[
\text{C.S.A.} = \text{Area of external hemisphere} + \text{Area of internal hemisphere}
\]
...
Find the diameter of a sphere whose surface area is \( 154 \text{ m}^2 \).
...
\[
\Rightarrow r^2 = 154 \times \frac{1}{4} \times \frac{7}{22}
\]
...
Let \( r_1 \) and \( r_2 \) be the radii of the balloons.

\[
\text{Given that, } \frac{r_1}{r_2} = \frac{12}{16} = \frac{3}{4}
\]

\[
\text{Now, ratio of C.S.A. of balloons} = \frac{4\pi r_1^2}{4\pi r_2^2} = \frac{r_1^2}{r_2^2} = \left(\frac{r_1}{r_2}\right)^2 = \left(\frac{3}{4}\right)^2 = \frac{9}{16}
\]
...
\[
\text{C.S.A. of the shell} = 2\pi (R^2 + r^2) \text{ sq. units}
\]
...
Therefore, C.S.A. \( = 213.71 \text{ m}^2 \) and T.S.A. \( = 264 \text{ m}^2 \)
...
\[
= 4\pi r^2 : 2\pi r^2 : \pi r\sqrt{2}r \quad (\because h = r \text{ and } l = \sqrt{h^2 + r^2} = \sqrt{2}r)
\]
...
1. The portion of a right circular cone intersected between two parallel planes is ______.
...
5. 4 persons live in a conical tent whose slant height is \( 19 \) m. If each person require \( 22 \text{ m}^2 \) of the floor area, then find the height of the tent.

6. A girl wishes to prepare birthday caps in the form of right circular cones for her birthday party, using a sheet of paper whose area is \( 5720 \text{ cm}^2 \), how many caps can be made with radius \( 5 \) cm and height \( 12 \) cm.
...
9. The internal and external diameters of a hollow hemispherical vessel are \( 20 \) cm and \( 28 \) cm respectively. Find the cost to paint the vessel all over at \( ₹0.14 \) per \( \text{cm}^2 \).

10. The frustum shaped outer portion of the table lamp has to be painted including the top part. Find the total cost of painting the lamp if the cost of painting \( 1 \text{ sq.cm} \) is \( ₹2 \).