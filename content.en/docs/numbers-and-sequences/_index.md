...
- To find the nth term of an A.P. and its sum to n terms.
- To find the nth term of a G.P. and its sum to n terms.
- To determine the sum of some finite series such as {{<katex>}}\sum n{{</katex>}}, {{<katex>}}\sum n^2{{</katex>}}, {{<katex>}}\sum n^3{{</katex>}}.
...
![Number carvings in Ishango Bone Fig. 2.1](introduction.png)
