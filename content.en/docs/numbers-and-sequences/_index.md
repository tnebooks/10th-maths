...
To study the concept of Euclid's Division Lemma. To understand Euclid's Division Algorithm. To find the LCM and HCF using Euclid's Division Algorithm. To understand the Fundamental Theorem of Arithmetic. To understand the congruence modulo 'n', addition modulo 'n' and multiplication modulo 'n'. To define sequence and to understand sequence as a function. To define an Arithmetic Progression (A.P.) and Geometric Progression (G.P.). To find the \(n^{th}\) term of an A.P. and its sum to \(n\) terms. To find the \(n^{th}\) term of a G.P. and its sum to \(n\) terms. To determine the sum of some finite series such as \(\sum n\), \(\sum n^2\), \(\sum n^3\).
...
<center>Number carvings in Ishango Bone Fig.2.1</center>
...
<table>
<tr><td>34</td><td>=</td><td>5</td><td>×</td><td>6</td><td>+</td><td>4</td></tr>
<tr><td>Total number of cakes</td><td>=</td><td>Number of cakes in each box</td><td>×</td><td>Number of boxes</td><td>+</td><td>Number of cakes left over</td></tr>
<tr><td>↓</td><td></td><td>↓</td><td></td><td>↓</td><td></td><td>↓</td></tr>
<tr><td>(Dividend)</td><td>=</td><td>(Divisor)</td><td>×</td><td>(Quotient)</td><td>+</td><td>(Remainder)</td></tr>
</table>
...
**Example 2.2** Find the quotient and remainder when \(a\) is divided by \(b\) in the following cases
...
In the previous section, we have studied about Euclid's division lemma and its applications. We now study the concept Euclid's Division Algorithm. The word 'algorithm' comes from the name of \(9^{\mathrm{th}}\) century Persian Mathematician Al-khwarizmi. An algorithm means a series of methodical step-by-step procedure of calculating successively on the results of earlier steps till the desired answer is obtained.
...
\(\therefore\) HCF is expressible in the form \(55x - 325 = 5\)
...
If \(a\) and \(b\) are two positive integers with \(a > b\) then G.C.D of \((a,b) = \mathrm{GCD}\) of \((a - b, b)\)
...
Using this Activity, find the HCF of (i) 90, 15 (ii) 80, 25 (iii) 40, 16 (iv) 23, 12 (v) 93, 13
...
\[
N = p_1^{q_1} \times p_2^{q_2} \times p_3^{q_3} \times \dots \times p_n^{q_n}
\]
...
**Solution** Since \(6^n = (2 \times 3)^n = 2^n \times 3^n\), \(2\) is a factor of \(6^n\). So, \(6^n\) is always even. But any number whose last digit is 5 is always odd. Hence, \(6^n\) cannot end with the digit 5.
...
<center>Life Cycle of Plant</center>
...
If \(a, b, c\) and \(d\) are integers and \(m\) is a positive integer such that \(a \equiv b \pmod{m}\) and \(c \equiv d \pmod{m}\) then
...
2. If \(59 \equiv 3 \pmod{7}\), \(46 \equiv 4 \pmod{7}\) then \(105 \equiv\) ______ \(\pmod{7}\), \(13 \equiv\) ______ \(\pmod{7}\), \(413 \equiv\) ______ \(\pmod{7}\), \(368 \equiv\) ______ \(\pmod{7}\).

3. The remainder when \(7 \times 13 \times 19 \times 23 \times 29 \times 31\) is divided by 6 is ______.

---

### 2.5.4 Solving linear congruences
...
If the \(n^{th}\) term is denoted by \(a_n\), then \(a_1\) is the first term, \(a_2\) is the second term, and so on. A sequence can be written as \(a_1, a_2, a_3, \dots, a_n, \dots\)

---

## Illustration

1. 1, 3, 5, 7, ... is a sequence with general term \(a_n = 2n - 1\). When we put \(n = 1, 2, 3, \ldots\), we get \(a_1 = 1\), \(a_2 = 3\), \(a_3 = 5\), \(a_4 = 7, \ldots\)

2. \(\frac{1}{2}, \frac{1}{3}, \frac{1}{4}, \frac{1}{5}, \ldots\) is a sequence with general term \(\frac{1}{n + 1}\). When we put \(n = 1, 2, 3, \ldots\) we get \(a_1 = \frac{1}{2}\), \(a_2 = \frac{1}{3}\), \(a_3 = \frac{1}{4}\), \(a_4 = \frac{1}{5}, \ldots\)
...
(i) 7, 13, 19, _____, _____

(ii) 2, _____, 10, 17, 26, _____

(iii) 1000, 100, 10, 1, _____, _____

2. A sequence is a function defined on the set of ______.

3. The \(n^{\mathrm{th}}\) term of the sequence 0, 2, 6, 12, 20, ... can be expressed as ______.
...
(iii) \(1, 0.1, 0.01, 0.001, \dots\)

**Solution** (i) \(\frac{1}{2}, \frac{1}{6}, \frac{1}{10}, \frac{1}{14}, \dots\)
...
Here each term is divided by 10.
...
We see that the numerator of \(n^{\mathrm{th}}\) term is \(n\), and the denominator is one more than the numerator. Hence,
...
So the general term \(a_n = (-1)^{n+1}5^n, \quad n \in \mathbb{N}\)
...
\[
a_1 = 1, \quad a_2 = 1, \quad a_n = \frac{a_{n-1}}{a_{n-2} + 3}; \quad n \geq 3, n \in \mathbb{N}
\]
...
(ii) \(a_n = \frac{n^2 - 4}{n}\); \(a_{11}\) and \(a_4\)
...
\frac{2n}{n+1}, & n \text{ is odd}
\end{cases}
\]

6. If \(a_1 = 1\), \(a_2 = 1\) and \(a_n = \frac{a_{n-1}^2}{a_{n-2} + 3}\), \(n \geq 3\), \(n \in \mathbb{N}\), then find the first six terms of the sequence.
...
is said to form Arithmetic Progression denoted by A.P. The number '\(a\)' is called the first term and '\(d\)' is called the common difference.
...
In general, the \(n^{\mathrm{th}}\) term denoted by \(t_n\) can be written as
...
\[
t_1 = a, \quad t_2 = a + d \quad \therefore t_2 - t_1 = (a + d) - a = d
\]

Similarly,

\[
t_2 = a + d, \quad t_3 = a + 2d \quad \therefore t_3 - t_2 = (a + 2d) - (a + d) = d
\]
...
(i) 1, 4, 7, 10, ... \(d = 4 - 1 = 7 - 4 = 10 - 7 = \ldots = 3\)

(ii) 6, 2, -2, -6, ... \(d = 2 - 6 = -2 - 2 = -6 - (-2) = \ldots = -4\)
...
(i) \(x + 2, 2x + 3, 3x + 4, \dots\)

(ii) \(2, 4, 8, 16, \dots\)

(iii) \(3\sqrt{2}, 5\sqrt{2}, 7\sqrt{2}, 9\sqrt{2}, \dots\)
...
\[
l = a + (n - 1)d \Rightarrow n = \left(\frac{l - a}{d}\right) + 1
\]
...
\[
n = \left(\frac{l - a}{d}\right) + 1 = \left(\frac{111 - 3}{3}\right) + 1 = \frac{108}{3} + 1 = 36 + 1 = 37
\]
...
\[
t_n = a + (n - 1)d = -13 + (n - 1) \times 2 = 2n - 15
\]
...
**Solution** Let \(a\) be the first term and \(d\) be the common difference. It is given that

\[
t_l = x, \quad t_m = y, \quad t_n = z
\]

Using the general term formula

\[
a + (l - 1)d = x \qquad \dots (1)
\]

\[
a + (m - 1)d = y \qquad \dots (2)
\]

\[
a + (n - 1)d = z \qquad \dots (3)
\]
...
(ii) \(\frac{1}{2}, \frac{1}{3}, \frac{1}{4}, \frac{1}{5}, \dots\)

(iii) \(9, 13, 17, 21, 25, \dots\)

(iv) \(-\frac{1}{3}, 0, \frac{1}{3}, \frac{2}{3}, \dots\)
...
3. Find the first term and common difference of the Arithmetic Progressions whose \(n^{\mathrm{th}}\) terms are given below

(i) \(t_n = -3 + 2n\)

(ii) \(t_n = 4 - 7n\)

4. Find the \(19^{\mathrm{th}}\) term of an A.P. \(-11, -15, -19, \ldots\)
...
12. The ratio of \(6^{\mathrm{th}}\) and \(8^{\mathrm{th}}\) term of an A.P. is 7:9. Find the ratio of \(9^{\mathrm{th}}\) term to \(13^{\mathrm{th}}\) term.
...
The sum of the terms of a sequence is called series. Let \(a_1, a_2, a_3, \ldots, a_n, \ldots\) be the sequence of real numbers. Then the real number \(a_1 + a_2 + a_3 + \dots\) is defined as the series of real numbers.
...
\[
S_n = a + (a + d) + (a + 2d) + \dots + (a + (n - 1)d) \qquad (1)
\]

Rewriting the above in reverse order

\[
S_n = (a + (n - 1)d) + (a + (n - 2)d) + \dots + (a + d) + a \qquad (2)
\]
...
**Example 2.32** Find the sum of \(0.40 + 0.43 + 0.46 + \dots + 1\).
...
\[
l = a + (n - 1)d \Rightarrow 1 = 0.40 + (n - 1)(0.03)
\]

\[
0.60 = 0.03(n - 1) \Rightarrow n - 1 = 20 \Rightarrow n = 21
\]
...
1. The \(n^{\mathrm{th}}\) term of any A.P. is of the form \(pn + q\) where \(p\) and \(q\) are some constants.

2. The sum to \(n^{\mathrm{th}}\) term of any A.P. is of the form \(pn^2 + qn + r\) where \(p\), \(q\), \(r\) are some constants.

---

**Example 2.34** The \(13^{\mathrm{th}}\) term of an A.P. is 3 and the sum of first 13 terms is 234. Find the common difference and the sum of first 21 terms.

**Solution** Given, the \(13^{\mathrm{th}}\) term \(= 3\) so, \(t_{13} = a + 12d = 3\) ...(1)
...
\[
2a + 12d = 36 \qquad \dots (2)
\]

Solving (1) and (2) we get,

\[
a = 33, \quad d = -\frac{5}{2}
\]
...
\[
S_{21} = \frac{21}{2}[66 - 50] = 168
\]

---

**Example 2.35** In an A.P. the sum of first \(n\) terms is \(\frac{5n^2}{2} + \frac{3n}{2}\). Find the \(17^{\mathrm{th}}\) term.

**Solution** The \(17^{\mathrm{th}}\) term can be obtained by subtracting the sum of first 16 terms from the sum of first 17 terms
...
The sum of all natural numbers between 300 and 600 is \(301 + 308 + 315 + \dots + 595\).
...
\[
\therefore S_n = \frac{n}{2}[a + l], \text{ we have } S_{43} = \frac{43}{2}[301 + 595] = 19264
\]
...
Number of white tiles \(= 1 + 2 + 3 + \dots + 12 = \frac{12}{2}[2 \times 1 + 11] = 78\)

Number of blue tiles \(= 0 + 1 + 2 + 3 + \dots + 11 = \frac{12}{2}[2 \times 0 + 11] = 66\)
...
It is given that \(1 + 2 + 3 + \dots + (x - 1) = (x + 1) + (x + 2) + \dots + 49\)
...
3. Find the sum of first 28 terms of an A.P. whose \(n^{\mathrm{th}}\) term is \(4n - 3\).

4. The sum of first \(n\) terms of a certain series is given as \(2n^2 - 3n\). Show that the series is an A.P.

5. The \(104^{\mathrm{th}}\) term and \(4^{\mathrm{th}}\) term of an A.P. are 125 and 0. Find the sum of first 35 terms.
...
12. Find the sum \(\left[\frac{a - b}{a + b} + \frac{3a - 2b}{a + b} + \frac{5a - 3b}{a + b} + \dots \text{ to } 12 \text{ terms}\right]\).
...
\(a, ar, ar^2, \ldots, ar^{n-1}, \ldots\) where \(a\) is the first term and \(r\) is the common ratio. Let \(t_n\) be the \(n^{\mathrm{th}}\) term of the G.P.
...
\[
\frac{t_2}{t_1} = \frac{ar}{a} = r, \quad \frac{t_3}{t_2} = \frac{ar^2}{ar} = r, \quad \frac{t_4}{t_3} = \frac{ar^3}{ar^2} = r, \quad \frac{t_5}{t_4} = \frac{ar^4}{ar^3} = r, \ldots
\]
...
(i) \(\frac{1}{8}, \frac{3}{4}, \frac{9}{2}, \ldots\)

(ii) \(7, \frac{7}{2}, \frac{7}{4}, \ldots\)
...
**Solution** (i) The general form of Geometric progression is \(a, ar, ar^2, \ldots\)
...
**Example 2.42** Find the \(8^{\mathrm{th}}\) term of the G.P. 9, 3, 1, ...

**Solution** To find the \(8^{\mathrm{th}}\) term we have to use the \(n^{\mathrm{th}}\) term formula \(t_n = ar^{n-1}\)
...
Therefore the \(8^{\mathrm{th}}\) term of the G.P. is \(\frac{1}{243}\).

---

**Example 2.43** In a Geometric progression, the \(4^{\mathrm{th}}\) term is \(\frac{8}{9}\) and the \(7^{\mathrm{th}}\) term is \(\frac{64}{243}\). Find the Geometric Progression.

**Solution** \(4^{\mathrm{th}}\) term, \(t_4 = \frac{8}{9} \Rightarrow ar^3 = \frac{8}{9}\) ...(1)

\(7^{\mathrm{th}}\) term, \(t_7 = \frac{64}{243} \Rightarrow ar^6 = \frac{64}{243}\) ...(2)

Dividing (2) by (1) we get,

\[
\frac{ar^6}{ar^3} = \frac{\frac{64}{243}}{\frac{8}{9}} \Rightarrow r^3 = \frac{8}{27} \Rightarrow r = \frac{2}{3}
\]

Substituting the value of \(r\) in (1), we get

\[
a \times \left(\frac{2}{3}\right)^3 = \frac{8}{9} \Rightarrow a = 3
\]
...
\[
a\left(\frac{1}{r} + 1 + r\right) = \frac{91}{3} \Rightarrow 7\left(\frac{1 + r + r^2}{r}\right) = \frac{91}{3}
\]
...
4. Three non-zero numbers \(a, b, c\) are in G.P. if and only if ______.

---

**Example 2.45** The present value of a machine is 40,000 and its value depreciates each year by \(10\%\). Find the estimated value of the machine in the \(6^{\mathrm{th}}\) year.
...
Value of the machine at the end of the \(2^{\mathrm{nd}}\) year is \(40,000 \times \left(\frac{90}{100}\right)^2\)
...
This sequence is in the form of G.P. with first term 40,000 and common ratio \(\frac{90}{100}\). For finding the value of the machine at the end of \(5^{\mathrm{th}}\) year (i.e. in \(6^{\mathrm{th}}\) year), we need to find the sixth term of this G.P.
...
\[
t_6 = 40000 \times \frac{9}{10} \times \frac{9}{10} \times \frac{9}{10} \times \frac{9}{10} \times \frac{9}{10} = 23619.6
\]

Therefore the value of the machine in \(6^{\mathrm{th}}\) year \(= ₹23619.60\)
...
6. In a G.P. the \(9^{\mathrm{th}}\) term is 32805 and \(6^{\mathrm{th}}\) term is 1215. Find the \(12^{\mathrm{th}}\) term.

7. Find the \(10^{\mathrm{th}}\) term of a G.P. whose \(8^{\mathrm{th}}\) term is 768 and the common ratio is 2.
...
What is his salary in the \(4^{\mathrm{th}}\) year with respect to the offers \(A\) and \(B\)?
...
\[
S_n = a + ar + ar^2 + \dots + ar^{n-2} + ar^{n-1} \qquad (1)
\]

Multiplying both sides by \(r\), we get

\[
rS_n = ar + ar^2 + ar^3 + \dots + ar^{n-1} + ar^n \qquad (2)
\]
...
If \(r = 1\), then \(S_n = a + a + a + \dots + a = na\)
...
**Solution** Here, the first term \(a = 1\), common ratio \(r = \frac{-3}{1} = -3 < 1\), Here, \(n = 8\).

Sum to \(n\) terms of a G.P. is \(S_n = \frac{a(r^n - 1)}{r - 1}\) if \(r \neq 1\)

\[
S_8 = \frac{1[(-3)^8 - 1]}{-3 - 1} = \frac{6561 - 1}{-4} = -1640
\]
...
\[
\therefore r = 4, \quad \frac{a(4^6 - 1)}{4 - 1} = 4095 \Rightarrow a \times \frac{4095}{3} = 4095
\]
...
**Example 2.48** How many terms of the series \(1 + 4 + 16 + \dots\) make the sum 1365?
...
\[
0.6666\ldots = 0.6 + 0.06 + 0.006 + 0.0006 + \dots
\]
...
\[
0.6666\ldots = 0.6 + 0.06 + 0.006 + 0.0006 + \dots = \frac{0.6}{1 - 0.1} = \frac{0.6}{0.9} = \frac{2}{3}
\]
...
**Example 2.51** The sides of a given square is \(10\mathrm{cm}\). The mid points of its sides are joined to form a new square. Again, the mid points of the sides of this new square are joined to form another square. This process is continued indefinitely. Find the sum of the areas and the sum of the perimeters of the squares formed through this process.

<center>Fig.2.15</center>

**Solution** For the given square,

Side \(= 10\mathrm{cm}\)

Area \(= 100\mathrm{cm}^2\)

Perimeter \(= 40\mathrm{cm}\)

For the new square formed by joining the mid points,

Side \(= \frac{10}{\sqrt{2}}\mathrm{cm}\)

Area \(= \left(\frac{10}{\sqrt{2}}\right)^2 = 50\mathrm{cm}^2\)

Perimeter \(= 4 \times \frac{10}{\sqrt{2}} = 20\sqrt{2}\mathrm{cm}\)

Thus, the areas are \(100, 50, 25, \ldots\) in G.P. with \(a = 100\), \(r = \frac{1}{2}\)

Sum of areas = \(\frac{100}{1 - \frac{1}{2}} = 200\mathrm{cm}^2\)

The perimeters are \(40, 20\sqrt{2}, 20, \ldots\) in G.P. with \(a = 40\), \(r = \frac{1}{\sqrt{2}}\)

Sum of perimeters = \(\frac{40}{1 - \frac{1}{\sqrt{2}}} = \frac{40\sqrt{2}}{\sqrt{2} - 1} = 40\sqrt{2}(\sqrt{2} + 1) = 80 + 40\sqrt{2}\mathrm{cm}\)

---

**Example 2.52** Find the sum to \(n\) terms of the series \(5 + 55 + 555 + \dots\)
...
**Example 2.53** Find the least positive integer \(n\) such that \(1 + 6 + 6^2 + \dots + 6^n > 5000\)
...
**Example 2.54** A person saved money every year, half as much as he could in the previous year. If he had totally saved ₹7875 in 6 years then how much did he save in the first year?
...
\[
\frac{a\left(1 - \frac{1}{64}\right)}{\frac{1}{2}} = 7875 \Rightarrow \frac{a \times \frac{63}{64}}{\frac{1}{2}} = 7875
\]

\[
a \times \frac{63}{64} \times 2 = 7875 \Rightarrow a \times \frac{63}{32} = 7875
\]
...
(i) \(5, -\frac{5}{3}, \frac{5}{9}, -\frac{5}{27}, \ldots\)
...
10. If \(S_n = \frac{x + y}{x^2 + xy + y^2} + \frac{x + y}{x^3 + x^2y + xy^2 + y^3} + \ldots\) to n terms then prove that

\[
(x - y)S_n = \frac{x^2 - y^2}{x^n - y^n}\left[\frac{x^n - 1}{x - 1} - \frac{y^n - 1}{y - 1}\right]
\]
...
\[
= \frac{2n^3 + 6n^2 + 6n - 3n^2 - 3n - 2n}{2}
\]

\[
= \frac{2n^3 + 3n^2 + n}{2} = \frac{n(2n^2 + 3n + 1)}{2}
\]
...
**Example 2.55** Find the sum of (i) \(1 + 2 + 3 + \dots + 60\) (ii) \(1^2 + 2^2 + 3^2 + \dots + 15^2\)

**Solution** (i) \(1 + 2 + 3 + \dots + 60 = \frac{60(60 + 1)}{2} = \frac{60 \times 61}{2} = 1830\)

(ii) \(1^2 + 2^2 + 3^2 + \dots + 15^2 = \frac{15(15 + 1)(2 \times 15 + 1)}{6} = \frac{15 \times 16 \times 31}{6} = 1240\)

---

**Example 2.56** Find the value of \(1^3 + 2^3 + 3^3 + \dots + 10^3\)

**Solution** \(1^3 + 2^3 + 3^3 + \dots + 10^3 = \left[\frac{10(10 + 1)}{2}\right]^2 = (55)^2 = 3025\)
...
**Solution** (i) \(1^3 + 2^3 + 3^3 + \dots + 16^3 = \left[\frac{16 \times (16 + 1)}{2}\right]^2 = (136)^2 = 18496\)

(ii) \(9^3 + 10^3 + \dots + 21^3 = (1^3 + 2^3 + 3^3 + \dots + 21^3) - (1^3 + 2^3 + 3^3 + \dots + 8^3)\)
...
**Example 2.58** If \(1 + 2 + 3 + \dots + n = 666\) then find \(n\).

**Solution** Since, \(1 + 2 + 3 + \dots + n = \frac{n(n + 1)}{2}\), we have
...
2. If \(1 + 2 + 3 + \dots + k = 325\), then find \(1^3 + 2^3 + 3^3 + \dots + k^3\).

3. If \(1^3 + 2^3 + 3^3 + \dots + k^3 = 44100\) then find \(1 + 2 + 3 + \dots + k\).
...
7. Find the sum of the series \((2^3 - 1^3) + (4^3 - 3^3) + (6^3 - 5^3) + \dots\) to
...
9. If 6 times of \(6^{\mathrm{th}}\) term of an A.P. is equal to 7 times the \(7^{\mathrm{th}}\) term, then the \(13^{\mathrm{th}}\) term of the A.P. is
...
10. An A.P. consists of 31 terms. If its \(16^{\mathrm{th}}\) term is \(m\), then the sum of all the terms of this A.P. is
...
12. If \(A = 2^{65}\) and \(B = 2^{64} + 2^{63} + 2^{62} + \dots + 2^0\) which of the following is true?
...
14. If the sequence \(t_1, t_2, t_3, \dots\) are in A.P. then the sequence \(t_6, t_{12}, t_{18}, \dots\) is
...
15. The value of \((1^3 + 2^3 + 3^3 + \dots + 15^3) - (1 + 2 + 3 + \dots + 15)\) is
...
6. Find the \(12^{\mathrm{th}}\) term from the last term of the A.P \(-2, -4, -6, \dots -100\).

7. Two A.P.'s have the same common difference. The first term of one A.P. is 2 and that of the other is 7. Show that the difference between their \(10^{\mathrm{th}}\) terms is the same as the difference between their \(21^{\mathrm{st}}\) terms, which is the same as the difference between any two corresponding terms.
...
9. Find the G.P. in which the \(2^{\mathrm{nd}}\) term is \(\sqrt{6}\) and the \(6^{\mathrm{th}}\) term is \(9\sqrt{6}\).
...
(i) Arithmetic Progression is \(a, a + d, a + 2d, a + 3d, \ldots\)
...
(i) Geometric Progression is \(a, ar, ar^2, \ldots, ar^{n-1}\)
...
(ii) Sum to first \(n\) terms of an G.P. is
...
(iv) Sum to infinite terms of a G.P. \(a + ar + ar^2 + \dots\) is

\[
S_{\infty} = \frac{a}{1 - r}, \text{ where } -1 < r < 1
\]
