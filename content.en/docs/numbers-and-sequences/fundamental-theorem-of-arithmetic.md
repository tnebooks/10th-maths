...
Since \( 6^n = (2 \times 3)^n = 2^n \times 3^n \), 2 is a factor of \( 6^n \). So, \( 6^n \) is always even. But any number whose last digit is 5 is always odd. Hence, \( 6^n \) cannot end with the digit 5.
