...
|-----|----------|----------------------|------|
| 1 | The identity function | f: ℝ → ℝ defined by f(x) = x |![](image-47.png) |
| 2 | Additive inverse function | f: ℝ → ℝ defined by f(x) = -x |![](image-48.png) |
...
|----------------------------------------|-------------|-------|
| f: ℝ → ℝ defined by f(x) = x², x ∈ ℝ; f(x) ∈ [0, ∞) | Parabola opening upward |![](image-50.png)|
| f: ℝ → ℝ defined by f(x) = -x², x ∈ ℝ; f(x) ∈ (-∞, 0] | Parabola opening downward |![](image-51.png)|
