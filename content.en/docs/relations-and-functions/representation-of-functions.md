...
Let \( A = \{1,2,3,4\} \) and \( B = \{2,5,8,11,14\} \) be two sets. Let \( f: A \to B \) be a function given by \( f(x) = 3x - 1 \). Represent this function
...
\[
A = \{1,2,3,4\}; \quad B = \{2,5,8,11,14\}; \quad f(x) = 3x - 1
\]
