...
The ordered pairs in the collection f = {(x, y) | y = f(x), x ∈ A} are plotted as points in the XY-plane. The graph of f is the totality of all such points.
...
The curves in **Fig. 1.18(b)** and **Fig. 1.18(d)** **do** represent a function as the vertical lines meet the curve in at most one point.
